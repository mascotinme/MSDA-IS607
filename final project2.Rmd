...
plot(airqualityuci$temp_ac, airqualityuci$benzene, main = "Scatter Plot", xlab = "Temperature", ylab = "Benzene", xlim =c(0, 50), ylim =c(-10, 20))
...
* https://nccd.cdc.gov/uscs/cancersbystateandregion.aspx (Data source)
